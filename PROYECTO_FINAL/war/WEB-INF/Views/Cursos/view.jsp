...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="/cursos">REGISTRO DE CURSOS</a>
			<li><a href="/cursos/carrera?id=<%=curso.getIdCarrera() %>">CARRERA</a>
			<li class="active"><a
				href="/curso/view?id=<%=request.getParameter("id")%>">MODIFICAR
					NOTA</a>
		</ul>
	</div>
	</nav> </header>
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-md-6">
				...
				<form id="form1" class="form-horizontal" action="/cursos/view"
					method="POST">
					<%
						/*
					%>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="idProfesor">
								...
								<option value="<%=profesor.getId()%>" selected><%=profesor.getNombre()+" "+profesor.getApellido()%></option>
								<%
									} else {
								%>
					...
					<div class="text-right">
						<a href="/cursos/carrera?id=<%=curso.getIdCarrera()%>" class="btn btn-danger">Cancelar</a>
