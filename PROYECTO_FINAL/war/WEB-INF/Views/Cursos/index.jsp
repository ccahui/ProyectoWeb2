...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="/cursos">REGISTRO DE CURSOS </a>
		</ul>
	</div>
	</nav> </header>
	<!--TABLA -->
	<div class="container">
		<h4 class="titulo">REGISTRO DE CURSOS  POR CARRERA :</h4>
		...
		<div class="row">
			<div class="col-md-5">
				<div class="list-group">
					...
					%>
					<a href = "/cursos/carrera?id=<%=carrera.getId()%>" class="list-group-item"><%=carrera.getNombre() %></a> 
 <%}
						} %>
				</div>
			</div>
