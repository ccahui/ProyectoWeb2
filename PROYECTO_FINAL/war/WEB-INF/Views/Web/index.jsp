...
<body>
	<header> <!-- MENU DE NAVEGACION donde inverse da el background black-->
		...
		<div class="collapse navbar-collapse" id="navegacion">
			<ul class="nav navbar-nav">
				<li class="dropdown">
					...
					data-toggle="dropdown" href="#">YouTube<span
						class="caret"></span>
				</a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="https://www.youtube.com/watch?v=eTVcGKztTiE">Funcion: Profesor Nota</a></li>
						<li><a href="https://www.youtube.com/watch?v=hDoVw2CCaRM">Funcion: Alumno Factura</a></li>
					</ul>
				</li>
				<li><a href="https://github.com/ccahui/ProyectoWeb2">Codigo GitHub</a></li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="/alumno/miNota">Ver mis Notas</a></li>
						<li><a href="/profesor/misCursos">Profesor</a></li>
	...
	</nav> <!--Culmina el menu de Navegacion --> </header>
