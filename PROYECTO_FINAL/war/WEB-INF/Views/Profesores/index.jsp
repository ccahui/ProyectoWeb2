		...
		<div class="table-responsive">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><%= prof.getDni() %></td>
					<td><%= prof.getGmail() %></td>
					<td><%= prof.estadoDescripcion() %></td>

					<td class='btn btn-group'><a
						href="/profesores/view?id=<%= prof.getId() %>"
						class="btn btn-primary btn-sm">Modificar</a> <a
						href="profesores/delete?id=<%= prof.getId() %>"
			...
			<div class="text-center">
				<a href="/profesores" class="btn btn-primary">ACTUALIZAR</a> <br>
			</div>
