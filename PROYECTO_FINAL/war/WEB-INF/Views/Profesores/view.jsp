...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			<li><a href="/profesores/add">INSERTAR PROFESOR</a></li>
		...
		<div class="row">
			<div class="col-sm-10 col-md-6">
				...
				<form id="form1" class="form-horizontal"
					action="/profesores/view" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control"
								placeholder="DNI Profesor" name="dni"
								pattern="[0-9]{8}" value=<%=prof.getDni()%>>
						</div>
					</div>
	...
	%>
	<div class="container">
		<h4 class="titulo" >Registro de Cursos que dicta</h4>
		<div class="row">
			<div class="col-md-5">
				...
				<ul>
					...
					%>
					<li class="list-group-item"><%=curso.getNombre()%></li>
					<%
						}
