...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			<li><a href="/facturas/add">INSERTAR FACTURA</a></li>
	...
	<div class="container-fluid">
		...
		<div class="table-responsive">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td class='btn btn-group'><a
						href="/facturas/view?id=<%=factura.getId()%>"
						class="btn btn-primary btn-sm">Modificar</a> <a
						href="/facturas/delete?id=<%=factura.getId()%>"
			...
			<div class="text-center">
				<a href="/facturas" class="btn btn-primary">ACTUALIZAR</a> <br>
			</div>
