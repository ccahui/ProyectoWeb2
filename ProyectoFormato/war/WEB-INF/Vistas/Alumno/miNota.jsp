...
<body>
	...
	<div class="container">
	    <div>
			<h4 class="titulo">Carrera Profesional: <%= carrera.getNombre() %></h4>
			<h5 class="titulo" >Alumno: <%=alumno.getNombre()+" "+alumno.getApellido()  %></h5>
			<h5 class="titulo" >Semestre: <%=alumno.getSemestre() %></h5>
