...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li class=""><a href="/curso">REGISTRO DE CURSOS</a>
			<li class="active"><a
				href="/curso/carrera?id=<%=request.getParameter("id")%>">CARRERA</a>
		</ul>
	</div>
	</nav> </header>
	<!--TABLA -->
	<div class="container">
		...
		<div class="table-responsive">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td class='btn btn-group'><a
						href="/curso/modificar?id=<%=curso.getId()%>"
						class="btn btn-primary btn-sm">Modificar</a> <a
						href="/curso/eliminar?id=<%=curso.getId()%>"
			...
			<div class="text-center">
				<a href="/curso/carrera?id=<%=request.getParameter("id")%>" class="btn btn-primary">ACTUALIZAR</a> <br>
			</div>
