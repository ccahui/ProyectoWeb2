...
<title>Curso: Registro de Notas</title>
...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<li><a href="/notas/add">INSERTAR NOTA</a></li>
			<li ><a href="/notas">REGISTRO DE NOTAS</a></li>
			<li ><a href="/notas/carrera?id=<%= request.getAttribute("idCarrera")%>">CARRERA</a></li>
			<li class="active"><a href="/notas/carrera/curso?id=<%= request.getParameter("id") %>">CURSO</a>
	...
	<div class="container-fluid">
		...
		<div class="table-responsive">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td class='btn btn-group'><a
						href="/notas/view?id=<%= nota.getId() %>"
						class="btn btn-primary btn-sm">Modificar</a> <a
						href="/notas/delete?id=<%= nota.getId() %>"
			...
			<div class="text-center">
				<a href="/notas/carrera/curso?id=<%= request.getParameter("id") %>" class="btn btn-primary">ACTUALIZAR</a> <br>
			</div>
