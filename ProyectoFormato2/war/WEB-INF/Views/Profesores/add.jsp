...
<script type="text/javascript" src="/js/profesor/insertar.js"></script>
...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			<li class="active"><a href="#">INSERTAR PROFESOR</a></li>
			<li><a href="/profesores">REGISTRO DE PROFESORES</a>
		</ul>
	</div>
	</nav> </header>
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-md-6">
				<!-- Crear Alumno -->
				<h4 class="titulo">DATOS DEL PROFESOR</h4>
				<form id="form1" class="form-horizontal" action="/profesores/add"
					method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" required
								placeholder="Ingrese DNI del Profesor" name="dni" pattern="[0-9]{8}">
						</div>
					</div>
					<div class="form-group">
