		...
		$.ajax({
			...
			success: function (data) {
				...
				if (charA === "1") {
					...
					var mensaje = "Alumno Insertardo al Sistema ";
					...
					document.getElementsByName('gmail')[0].value = "";
					document.getElementsByName('nombre')[0].focus();
				}
				else if(charA === "2"){
					
					var mensaje = "Alumno registrado con mismo DNI";
					...
					var mensaje = "Fallo al intentar Insertar Alumno al Sistema";
