		...
		$.ajax({
			...
			success: function (data) {
				...
				if (charA === "1") {
					...
					var mensaje = "Usuario Insertardo al Sistema ";
					...
					var mensaje = "Exites un Usuario con el mismo GMAIL en el Sistema";
					...
					var mensaje = "Fallo al intentar Insertar el USUARIO al Sistema";
