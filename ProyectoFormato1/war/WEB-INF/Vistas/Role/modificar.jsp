...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="/role">REGISTRO DE ROLES</a>
		</ul>
	</div>
	</nav> </header>
	<div class="container">
				...
				<form id="form1" class="form-horizontal" action="/role/modificar"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input class="form-control" placeholder="Nombre Role"
					...
					<div class="text-right">
						<a href="/role" class="btn btn-danger">CANCELAR</a>
