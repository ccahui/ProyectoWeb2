...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="/alumno/carrera?id=<%=alumno.getIdCarrera()%>">CARRERA</a>
			<li class="active"><a
				href="/alumno/modificar?id=<%=alumno.getId()%>">MODIFICAR ALUMNO</a>
		</ul>
	</div>
	</nav> </header>
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-md-6">
				...
				<form id="form1" class="form-horizontal" action="/alumno/modificar"
					method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" placeholder="DNI del Alumno"
								name="dni" type="text" value=<%=alumno.getDni()%>>
						</div>
					</div>
					...
					<div class="text-right">
						<a href="/alumno/carrera?id=<%=alumno.getIdCarrera() %>" class="btn btn-danger">Cancelar</a>
