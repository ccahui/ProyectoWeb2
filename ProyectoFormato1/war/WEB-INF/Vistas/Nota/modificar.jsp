					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" placeholder="Nota1" name="nota1"
								type="text" value="<%=nota.getNota1() == null ? "":nota.getNota1() %>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" placeholder="Nota2" name="nota2"
								type="text" value="<%=nota.getNota2() == null ? "":nota.getNota2() %>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" placeholder="Nota3" name="nota3"
								type="text"  value="<%=nota.getNota3() == null ? "":nota.getNota3() %>">
						</div>
					</div>
					<div class="text-right">
						<a href="/nota/carrera/curso?id=<%=curso.getId()%>" class="btn btn-danger">Cancelar</a>
